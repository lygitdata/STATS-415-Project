...
FULLDATA = FULLDATA[c("BPXLEVEL","SEQN", "RIAGENDR", "RIDAGEYR", "RIDRETH3", "BPXPLS")]
FULLDATA = FULLDATA %>%
  mutate(
...
FULLDATA = FULLDATA[c("BPXLEVEL", "BPXPLS", "DR1TCARB", "DR1TPROT", "DR1TFIBE","DR1TTFAT", "DR1TCHOL", "RIAGENDR", "RIDAGEYR", "RIDRETH3")]
...
xgboost.all = xgboost.train(colnames(train.X.dummy)[2:15])
...
importance.matrix = xgb.importance(colnames(train.X.dummy)[2:15], model = xgboost.all[[1]])
importance.matrix
```
